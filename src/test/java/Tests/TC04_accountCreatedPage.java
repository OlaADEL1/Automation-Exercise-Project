...
public class TC04_accountCreatedPage {
    ...
    @Description("This test case checks if the user account was successfully created.")
    @Owner("Ola")
    @Test
    public void checkLoggedInScreen() {
        ...
        //TODO Logged In Page
        String actual=new P04_accountCreatedPage(getDriver())
                .clickONContinueButton().getUserNameMessage();
